...
<%
      ...
      String mytitre = (String) request.getAttribute("titrefilm");
		out.println(mytitre.toString());
		 //String mydate = (String) request.getAttribute("anneefilm");
		 //out.println(mydate.toString());
%><br></br>
<a href="./DisplayFilmForm.jsp">retour</a>
</div>
</div>
</body>
</html>