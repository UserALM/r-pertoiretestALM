...
<title>Votre acteur</title><link rel="stylesheet" type="text/css" href="../style.css" />
</head>
<body>
<!-- debut design -->
<div id="header">
...
<h1>Votre acteur :</h1>
<%
	String nameactor = (String) request.getAttribute("nameactor");
	out.println(nameactor.toString());
%><br></br>
<a href="./DisplayActorForm.jsp">retour</a>
</div>
</div>
</body>
</html>