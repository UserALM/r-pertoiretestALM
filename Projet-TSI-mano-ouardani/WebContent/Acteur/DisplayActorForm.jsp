...
<title>ListeActeurs</title><link rel="stylesheet" type="text/css" href="../style.css" />
</head>
<body>
<!-- debut design -->
<div id="header">
...
%>
<h1> ACTEURS </h1>
<h2>Afficher un acteur:</h2> 
<div><% 
	// simplement, on récupere la liste des users!!!
    for (int i = 0; i < listActors.size(); i++) {
    	out.println("<div><a href=\"FindActor?name=" +listActors.get(i).getNom()+ "\">" +listActors.get(i).getNom()+ "</a></div>" );     	
    }
%> </div>
<br></br>
<div>
<form action ="FindActor" methode="post">
